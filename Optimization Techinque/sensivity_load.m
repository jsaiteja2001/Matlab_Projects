...
prc(houses*2,1)=price_electricity;
prc(houses*2,2)=reliability;
prc(houses*2,3)=b(1);%pv contribution
prc(houses*2,4)=b(2);%wind contribution
prc(houses*2,5)=b(3);%battery contribution
prc(houses*2,6)=b(4);%diesel contribution
end